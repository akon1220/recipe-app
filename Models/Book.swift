...
extension Book {
  static let previewData = [
    ...
    Book(id: "OL5731542W", title: "Half of a Yellow Sun", author: "Chimamanda Ngozi Adichie", coverUrl: URL(string:"https://education-jrp.s3.amazonaws.com/BookImages/Book-YellowSun.jpg")!),
